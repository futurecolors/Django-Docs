...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('livedocs_item', 'version', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['livedocs.Version']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.version'
        db.delete_column('livedocs_item', 'version_id')
